...
//
// Related Topics 哈希表 链表 双指针 👍 2534 👎 0
...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        return fun0(headA, headB);
    }

    public ListNode fun0(ListNode headA, ListNode headB) {
    ...
    // 自己写的，无法判断什么时候结束，得加个布尔
    public ListNode fun1(ListNode headA, ListNode headB) {
        ...
        while (curA != null && curB != null) {
            ...
            curA = curA.next;
            if (!changeA && curA == null) {
                curA = headB;
                changeA = true;
            }
            curB = curB.next;
            if (!changeB && curB == null) {
                curB = headA;
                changeB = true;
            }
        }
